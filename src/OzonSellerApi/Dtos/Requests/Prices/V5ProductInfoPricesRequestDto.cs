...
public class V5ProductInfoPricesRequestDto
{
    ...
    public required ProductInfoPricesRequestDtoFilter Filter { get; set; }
...
/// Фильтр по товарам.
/// </summary>
public class ProductInfoPricesRequestDtoFilter
{
    /// <summary>
    /// Фильтр по параметру <c>OfferId</c>. Можно передавать список значений.
    /// </summary>
    [JsonPropertyName("offer_id")]
    public List<string> OfferId { get; set; } = [];

    /// <summary>
    /// Фильтр по параметру <c>ProductId</c>. Можно передавать список значений.
    /// </summary>
